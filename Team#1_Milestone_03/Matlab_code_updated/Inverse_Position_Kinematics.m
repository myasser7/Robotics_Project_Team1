function [q1, q2, q3] = Inverse_Position_Kinematics(Xe, Ye, Ze)
    ...
    initial_guess = [40; 40; 40]; % You can modify this as needed
    ...
    q1 = mod(current_guess(1), 360); % Ensure angle is between 0° and 360°
    q2 = mod(current_guess(2), 360);
    q3 = mod(current_guess(3), 360);
end
