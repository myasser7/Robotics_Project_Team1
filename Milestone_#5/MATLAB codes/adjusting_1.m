%first trajectory 
function [q1_4 , q2_4 , q3_4 , t4] = adjusting_1()

T4 = 1; % Duration in seconds
dt = 0.1; % Time step
t4 = 0:dt:T4; % Time vector

% Initial and final positions for end-effector
x0 = 0; y0 = 29.4853; z0 = 0;  % Initial position
xf = 0; yf = 29.4853; zf = 10;   % Final position
...
coeffs_q1_4 = solve_5th_order_polynomial(q1_0, q1_f, q1_dot_0, q1_dot_f, q1_ddot_0, q1_ddot_f, T4);
coeffs_q2_4 = solve_5th_order_polynomial(q2_0, q2_f, q2_dot_0, q2_dot_f, q2_ddot_0, q2_ddot_f, T4);
coeffs_q3_4 = solve_5th_order_polynomial(q3_0, q3_f, q3_dot_0, q3_dot_f, q3_ddot_0, q3_ddot_f, T4);

% Evaluate joint trajectories over time
q1_4 = evaluate_trajectory_5th_order(coeffs_q1_4, t4);
q2_4 = evaluate_trajectory_5th_order(coeffs_q2_4, t4);
q3_4 = evaluate_trajectory_5th_order(coeffs_q3_4, t4);
