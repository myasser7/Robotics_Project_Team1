%Second trajectory 
function [q1_2 , q2_2 , q3_2 , t2] = second_traj()
T2 = 5; % Duration in seconds
dt = 0.1; % Time step
t2 = 0:dt:T2; % Time vector

% Initial and final positions for end-effector
x0 = 0; y0 = 29.4853; z0 = 10;  % Initial position
xf = 29.4853; yf = 0; zf =10;  % Final position
...
coeffs_q1_2 = solve_5th_order_polynomial(q1_0, q1_f, q1_dot_0, q1_dot_f, q1_ddot_0, q1_ddot_f, T2);
coeffs_q2_2 = solve_5th_order_polynomial(q2_0, q2_f, q2_dot_0, q2_dot_f, q2_ddot_0, q2_ddot_f, T2);
coeffs_q3_2 = solve_5th_order_polynomial(q3_0, q3_f, q3_dot_0, q3_dot_f, q3_ddot_0, q3_ddot_f, T2);

% Evaluate joint trajectories over time
q1_2 = evaluate_trajectory_5th_order(coeffs_q1_2, t2);
q2_2 = evaluate_trajectory_5th_order(coeffs_q2_2, t2);
q3_2 = evaluate_trajectory_5th_order(coeffs_q3_2, t2);
