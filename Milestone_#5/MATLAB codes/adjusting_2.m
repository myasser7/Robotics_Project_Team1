%first trajectory 
function [q1_5 , q2_5 , q3_5 , t5] = adjusting_2()

T5 = 1; % Duration in seconds
dt = 0.1; % Time step
t5 = 0:dt:T5; % Time vector

% Initial and final positions for end-effector
x0 = 29.4853; y0 = 0; z0 = 10;  % Initial position
xf = 29.4853; yf = 0; zf = 0;   % Final position
...
coeffs_q1_5 = solve_5th_order_polynomial(q1_0, q1_f, q1_dot_0, q1_dot_f, q1_ddot_0, q1_ddot_f, T5);
coeffs_q2_5 = solve_5th_order_polynomial(q2_0, q2_f, q2_dot_0, q2_dot_f, q2_ddot_0, q2_ddot_f, T5);
coeffs_q3_5 = solve_5th_order_polynomial(q3_0, q3_f, q3_dot_0, q3_dot_f, q3_ddot_0, q3_ddot_f, T5);

% Evaluate joint trajectories over time
q1_5 = evaluate_trajectory_5th_order(coeffs_q1_5, t5);
q2_5 = evaluate_trajectory_5th_order(coeffs_q2_5, t5);
q3_5 = evaluate_trajectory_5th_order(coeffs_q3_5, t5);
